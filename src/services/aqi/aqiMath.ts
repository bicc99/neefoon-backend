...
export const PM25_BREAKPOINTS: Breakpoint[] = [
  { cLow: 0.0,   cHigh: 9.0,   iLow: 0,   iHigh: 50,  label: 'Good',                           color: '#7ED07A', textColor: '#08331C', colorKey: 'c_good',      advice: 'Great day to be outside' },
  { cLow: 9.1,   cHigh: 35.4,  iLow: 51,  iHigh: 100, label: 'Moderate',                       color: '#FFE15A', textColor: '#3D2E00', colorKey: 'c_moderate',  advice: 'Air quality is acceptable for most people' },
  { cLow: 35.5,  cHigh: 55.4,  iLow: 101, iHigh: 150, label: 'Unhealthy for Sensitive Groups', color: '#FF9E4A', textColor: '#3A1A00', colorKey: 'c_usg',       advice: 'Sensitive groups should reduce outdoor activity' },
  { cLow: 55.5,  cHigh: 125.4, iLow: 151, iHigh: 200, label: 'Unhealthy',                      color: '#F05A5A', textColor: '#FFFFFF', colorKey: 'c_unhealthy', advice: 'Air quality is not ideal for outdoor activity' },
  { cLow: 125.5, cHigh: 225.4, iLow: 201, iHigh: 300, label: 'Very Unhealthy',                 color: '#A16BC7', textColor: '#FFFFFF', colorKey: 'c_very',      advice: 'It is better to stay indoors' },
  { cLow: 225.5, cHigh: 325.4, iLow: 301, iHigh: 500, label: 'Hazardous',                      color: '#7E2A3A', textColor: '#FFFFFF', colorKey: 'c_hazardous', advice: 'Avoid going outside unless necessary' },
];
